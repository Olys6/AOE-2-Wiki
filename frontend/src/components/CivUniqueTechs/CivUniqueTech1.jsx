...
const CivUniqueTech1 = ({ name, description, age, develops_in, cost, build_time, applies_to }) => {
      ...
      <Card className="uniqueUnitCard" sx={{ maxWidth: "100%" }}>
        <CardContent>
          <Typography variant="h5" component="div">
            Unique Tech:  <span style={{ color: "#00dd07" }}>{name}</span>
          </Typography>
          <br />
